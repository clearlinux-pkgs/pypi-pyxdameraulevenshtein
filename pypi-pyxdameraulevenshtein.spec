...
Requires: pypi-pyxdameraulevenshtein-license = %{version}-%{release}
...
%package license
Summary: license components for the pypi-pyxdameraulevenshtein package.
Group: Default

%description license
license components for the pypi-pyxdameraulevenshtein package.
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pypi-pyxdameraulevenshtein
cp %{_builddir}/pyxDamerauLevenshtein-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyxdameraulevenshtein/afd170592612584802f4a53ed2d7201c44afa702 || :
...
/usr/share/package-licenses/pypi-pyxdameraulevenshtein/afd170592612584802f4a53ed2d7201c44afa702
